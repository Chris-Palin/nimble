...
/* React port of the Arabella. shell. Tools keep shipping as static pages
   from public/studio/tools and load in kept-alive iframes, exactly like the
...
export const TOOLS: Tool[] = [
  { id: 'home',    name: 'Home',    meta: 'Studio overview',    src: '/studio/home.html' },
  { id: 'mash',    name: 'Mash',    meta: 'Mesh gradients',     src: '/studio/tools/mesh-gradient/index.html' },
  { id: 'stage',   name: 'Stage',   meta: 'Screenshot mockups', src: '/studio/tools/stage/index.html' },
  { id: 'digit',   name: 'Digit',   meta: 'Gesture FX',         src: '/studio/tools/digit/index.html' },
  { id: 'motion',  name: 'Motion',  meta: 'Motion graphics',    src: '/studio/tools/motion/index.html' },
  { id: 'stipple', name: 'Stipple', meta: 'Dither & halftone',  src: '/studio/tools/dither/index.html' },
];
...
const initialTool = () => {
  ...
  const last = localStorage.getItem('studio-last-tool');
...
export const useShell = create<ShellState>((set, get) => ({
  ...
  toggleCollapsed: () => {
    ...
    localStorage.setItem('studio-collapsed', next ? '1' : '0');
    set({ collapsed: next });
  },
}));
